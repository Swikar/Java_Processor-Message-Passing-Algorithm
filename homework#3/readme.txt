Group 10 : Swikar, Shantanu, Saurabh
...
2. Import the extracted project as an existing java project in eclipse
3. Run

Second -
1. Keep both the Processor.java and Main.java in the same directory
